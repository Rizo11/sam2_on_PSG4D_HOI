...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default="/home/rizo/mipt_ccm/sam2/hoi/HOI4D_release")
    parser.add_argument('--output_dir', type=str, default="/home/rizo/mipt_ccm/sam2/hoi/HOI4D")
